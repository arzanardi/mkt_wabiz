        ...
        youtubeVideoGallery:function(options) {
            ...
            function load($this, options) {
                ...
                for (var i = 0, l = videos.length; i < l; i++){
                    ...
                    html+= '<li class="youtube-videogallery-item"><a title="'+video.title+'" data-youtube-id="'+ video.id +'" href="'+ href +'" class="youtube-videogallery-link" ><img class="youtube-videogallery-play" src="'+ playButtonSrc +'" title="play" /><img class="youtube-videogallery-img" src="'+ src +'" style="width:100%" />'+ titleSpan +'</a></li>';
                }
                $this.empty()
                    .append(html)
