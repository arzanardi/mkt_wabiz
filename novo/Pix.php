...
class Pix {
  ...
  private function getMerchantAccountInformation() {
    ...
    // Chave Pix
    $pixKey = str_replace("-", "", $this->pixKey);
    ...
    $this->getValue(self::ID_MERCHANT_ACCOUNT_INFORMATION_DESCRIPTION, $this->remove_accents($this->description)) :
    '';
  ...
  public function getPayload() {
    ...
    $payload = 
      ...
      $this->getValue(self::ID_MERCHANT_NAME, $this->remove_accents($this->merchantName)) .
      $this->getValue(self::ID_MERCHANT_CITY, $this->remove_accents($this->merchantCity)) . 
